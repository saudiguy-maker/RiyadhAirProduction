...
import Research, { EvidenceList } from './Research.jsx';
...
export default function App() {
  ...
  return (
    <div className="wrap">
      ...
      <Research operator={op} orders={orders} />

      <section className="orderbook">
        <h2>Order announcements and commitments</h2>
      ...
      {open && (
        <div className="sheet" onClick={() => setOpen(null)}>
          <div className="sheetin" onClick={(e) => e.stopPropagation()}>
            ...
            <h3>Aircraft evidence</h3>
            <EvidenceList rows={detail?.evidence ?? []} />
            <h3>Legacy and tracked stage history</h3>
            <p className="dim">A later stage does not prove that every earlier milestone has been independently verified.</p>
            <div className="hist">
              {STAGES.map((s) => {
